...
<!--             <div class="container"> -->
				<div id="title" class="d-flex justify-content-center" style="width: 80vw;">
			  		<span style="font-size: 20px; font-weight: 550; color: #012970c7; font-family: 'Nunito', sans-serif;">${company} 전체 <span id="year"></span>년 <span id="month"></span>월 용역 매출 현황 [매출실적]</span>
				</div>
                ...
                <div class="toggle-content mt-3" id="toggle-item">
                    ...
                    <div class="float-end" style="height: 3vw">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            tui.Grid.applyTheme('striped', {
	            ...
	            $.ajax({
	                url: "${pageContext.request.contextPath}/salesResultTotal.ajax/company/${company}/batch_month/" + yyyymm,
	                method: "GET",
	                success: function (salesResultTotal) {
	                	salesResultTotal.forEach(item => {
	                		item.이익 = Number(item.매출가) - Number(item.매입가);
	                	});
	                    grid.resetData(salesResultTotal);
            ...
            grid.on('dblclick', function (ev) {
               ...
               if (!salesResult.sales_result_id) {
               	alert('총합계 데이터입니다')
            ...
            $("#toggle-icon").click(function () {
       		...
       		$('#btnKeywordSearch').click(function() {
                ...
                if (regex.test($('#keyword').val())) {
                    ...
                    $.ajax({
                        url: "${pageContext.request.contextPath}/salesResultTotal.ajax/company/${company}/batch_month/" + $('#keyword').val(),
                        method: "GET",
                        success: function (salesResultTotal) {
                        	salesResultTotal.forEach(item => {
                                item.이익 = Number(item.매출가) - Number(item.매입가);
