		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<security:authorize access="isAuthenticated()">
				<li class="nav-item">
					...
					<a class="nav-link collapsed" href="${pageContext.request.contextPath}/empStatusList_total">
			...
			<security:authorize access="hasAuthority('통합 관리자') or hasAuthority('IYCNC 관리자')">
				...
				<a class="nav-link collapsed" href="${pageContext.request.contextPath}/iycnc/salesCostStatusListTotal">
                		<i class="bi bi-dash"></i>
                		<span>전체매출원가현황</span>
            		</a>
				<a class="nav-link collapsed" href="${pageContext.request.contextPath}/iycnc/salesEstimationListTotal">
                		<i class="bi bi-dash"></i>
                		<span>전체추정</span>
            		</a>
				<a class="nav-link collapsed" href="${pageContext.request.contextPath}/iycnc/salesResultListTotal">
                		<i class="bi bi-dash"></i>
                		<span>전체실적</span>
            		</a>
				<li class="nav-item">
					<a class="nav-link collapsed" data-bs-target="#iycnc-ito-nav" data-bs-toggle="collapse" href="#">
						<i class="bi bi-list"></i><span>ITO</span><i class="bi bi-chevron-down ms-auto"></i>
					</a>
				...
				<li class="nav-item">
					<a class="nav-link collapsed" data-bs-target="#iycnc-idc-nav" data-bs-toggle="collapse" href="#">
						<i class="bi bi-list"></i><span>IDC</span><i class="bi bi-chevron-down ms-auto"></i>
					</a>
					...
					<ul id="iycnc-idc-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
						...
						<li>
							<a href="${pageContext.request.contextPath}/iycnc/idc/salesCostStatusList">
								<i class="bi bi-circle"></i><span>매출원가현황</span>
							</a>
						</li>
					</ul>
				...
				<li class="nav-item">
					<a class="nav-link collapsed" data-bs-target="#iycnc-conversion-nav" data-bs-toggle="collapse" href="#">
						<i class="bi bi-list"></i><span>컨버전스</span><i class="bi bi-chevron-down ms-auto"></i>
					</a>
					...
					<ul id="iycnc-conversion-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
						...
						<li>
							<a href="${pageContext.request.contextPath}/iycnc/conversion/salesCostStatusList">
								<i class="bi bi-circle"></i><span>매출원가현황</span>
							</a>
						</li>
					</ul>
				...
				<li class="nav-item">
					<a class="nav-link collapsed" data-bs-target="#iycnc-infra-nav" data-bs-toggle="collapse" href="#">
						<i class="bi bi-list"></i><span>인프라</span><i class="bi bi-chevron-down ms-auto"></i>
					</a>
			...
			<security:authorize access="hasAuthority('통합 관리자') or hasAuthority('IBTS 관리자')">
				...
				<a class="nav-link collapsed" href="${pageContext.request.contextPath}/ibts/salesCostStatusListTotal">
                		<i class="bi bi-dash"></i>
                		<span>전체매출원가현황</span>
            		</a>
            	<a class="nav-link collapsed" href="${pageContext.request.contextPath}/ibts/salesEstimationListTotal">
                		<i class="bi bi-dash"></i>
                		<span>전체추정</span>
            	</a>
				<a class="nav-link collapsed" href="${pageContext.request.contextPath}/ibts/salesResultListTotal">
                		<i class="bi bi-dash"></i>
                		<span>전체실적</span>
            		</a>
				<li class="nav-item">
					...
					<ul id="ibts-ito-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
						...
						<li>
							<a href="${pageContext.request.contextPath}/ibts/ito/salesCostStatusList">
								<i class="bi bi-circle"></i><span>매출원가현황</span>
							</a>
						</li>
					</ul>
				...
				<li class="nav-item">
					...
					<ul id="ibts-idc-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
						...
						<li>
							<a href="${pageContext.request.contextPath}/ibts/idc/salesCostStatusList">
								<i class="bi bi-circle"></i><span>매출원가현황</span>
							</a>
						</li>
					</ul>
				...
				<li class="nav-item">
					...
					<ul id="ibts-conversion-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
						...
						<li>
							<a href="${pageContext.request.contextPath}/ibts/conversion/salesCostStatusList">
								<i class="bi bi-circle"></i><span>매출원가현황</span>
							</a>
						</li>
					</ul>
			...
			<security:authorize access="hasAuthority('통합 관리자') or hasAuthority('IYS 관리자')">
				...
				<a class="nav-link collapsed" href="${pageContext.request.contextPath}/iys/salesCostStatusListTotal">
                		<i class="bi bi-dash"></i>
                		<span>전체매출원가현황</span>
            		</a>
            		<a class="nav-link collapsed" href="${pageContext.request.contextPath}/iys/salesEstimationListTotal">
                		<i class="bi bi-dash"></i>
                		<span>전체추정</span>
            	</a>
				<a class="nav-link collapsed" href="${pageContext.request.contextPath}/iys/salesResultListTotal">
                		<i class="bi bi-dash"></i>
                		<span>전체실적</span>
            		</a>
				<li class="nav-item">
					...
					<ul id="iys-ito-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
						...
						<li>
							<a href="${pageContext.request.contextPath}/iys/ito/salesCostStatusList">
								<i class="bi bi-circle"></i><span>매출원가현황</span>
							</a>
						</li>
					</ul>
				...
				<li class="nav-item">
					...
					<ul id="iys-idc-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
						...
						<li>
							<a href="${pageContext.request.contextPath}/iys/idc/salesCostStatusList">
								<i class="bi bi-circle"></i><span>매출원가현황</span>
							</a>
						</li>
					</ul>
				...
				<li class="nav-item">
					...
					<ul id="iys-conversion-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
						...
						<li>
							<a href="${pageContext.request.contextPath}/iys/conversion/salesCostStatusList">
								<i class="bi bi-circle"></i><span>매출원가현황</span>
							</a>
						</li>
					</ul>
