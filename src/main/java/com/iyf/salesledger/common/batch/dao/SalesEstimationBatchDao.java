...
public interface SalesEstimationBatchDao {
	...
	void insertTotalManual(@Param("company") String company, @Param("batch_month") String batch_month);

	void deleteTotalManual(@Param("company") String company, @Param("batch_month") String batch_month);
}
