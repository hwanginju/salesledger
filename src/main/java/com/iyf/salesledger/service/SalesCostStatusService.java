...
public class SalesCostStatusService {
	...
	public List<Map<String, Object>> getSalesCostStatuslistTotal(Map<String, Object> requestMap) {
		return salesCostStatusDao.getSalesCostStatuslistTotal(requestMap);
	}
